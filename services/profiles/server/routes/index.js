...
router.post('/create/profile', publicMiddleware, controllers.createProfile);
router.post('/change/profile', publicMiddleware, controllers.changeProfile);
router.get('/get/profile/:id', publicMiddleware, controllers.getProfile);
